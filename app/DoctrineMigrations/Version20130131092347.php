 ...
 */
class Version20130131092347 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE department CHANGE ware_id_city ware_id_city VARCHAR(10) DEFAULT NULL");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE department CHANGE ware_id_city ware_id_city VARCHAR(10) NOT NULL");
    }
}
